...
const UnauthorisedPage = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-center w-screen h-screen gap-12 py-8 cursor-pointer " onClick={()=>navigate(-1)}>
      <svg
        className="h-[50vh] aspect-video"
        xmlns="http://www.w3.org/2000/svg"
        viewBox="0 0 500 500"
        aria-label="Security illustration with padlock and character"
        role="img"
      >
        ...
        <g id="freepik--Text--inject-3">
          ...
          ></path>
          <path
            d="M352.48,174.33c0-12.45,6.56-19.57,18.57-19.57s18.58,7.12,18.58,19.57v40.49c0,12.46-6.57,19.57-18.58,19.57s-18.57-7.11-18.57-19.57Zm12.23,41.27c0,5.56,2.45,7.67,6.34,7.67s6.34-2.11,6.34-7.67v-42c0-5.57-2.44-7.68-6.34-7.34-7.68s-6.34,2.11-6.34,7.68Z"
            style={{ fill: "#263238" }}
          ></path>
          <path
      ...
      <div className="flex flex-col items-center gap-4">
        ...
        You tried to access a page you did not have prior authorization for. Click anywhere to go back.
        </p>
      </div>
    </div>
  );
